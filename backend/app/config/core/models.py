...
class Document(models.Model):
    ...
    document_file_type = models.CharField(
        _("Document File Type (PDF, XLS, TEXT, or etc)"),
        max_length=50,
        null=True,
        blank=True)
...
class dsb_user_publisher(models.Model):
    dsb_user_publisher_id = models.TextField(
        default=uuid.uuid4,
        primary_key=True,
        max_length=36,
        editable=False
    ...
    last_update_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name=_("Last Updated by User"),
        related_name='updated_dsb_user_publisher',
    ...
    registered_user_email = models.TextField(
        _("Email when Initiating Registration (from Danasaham Core)"),
        blank=True,
        null=True
    )
    users_phone_number = models.TextField(
    ...
    publisher_registered_name = models.TextField(
        _("Publisher Registered Name (from Danasaham Core)"),
        blank=True,
        null=True
    )
    publisher_corporate_type = models.TextField(
        _("Publisher Corporate Type (from Danasaham Core)"),
        blank=True,
        null=True
    )
    publisher_phone_number = models.TextField(
        _("Publisher Phone Number (from Danasaham Core)"),
        blank=True,
        null=True
    )
    publisher_business_field = models.TextField(
        _("Publisher Business Field (from Danasaham Core)"),
        blank=True,
        null=True
    )
    publisher_main_business = models.TextField(
    ...
    domicile_address_publisher_3_city = models.TextField(
    ...
    pengurus_id = models.TextField(
        _("Pengurus ID (from Danasaham Core)"),
        blank=True,
        null=True
    )
    pengurus_name = models.TextField(
        _("Pengurus Name (from Danasaham Core)"),
        blank=True,
        null=True
    )
    pengurus_id_number = models.TextField(
        _("Pengurus ID Number (from Danasaham Core)"),
        blank=True,
        null=True
    )
    pengurus_phone_number = models.TextField(
        _("Pengurus Phone Number (from Danasaham Core)"),
        blank=True,
        null=True
    )
    role_as = models.TextField(
        _("Role as (from Danasaham Core)"),
        blank=True,
        null=True
    )
    jabatan_pengurus = models.TextField(
    ...
    tempat_lahir_pengurus = models.TextField(
    ...
    def __str__(self):
        return f"{self.dsb_user_publisher_id} - {self.publisher_registered_name} - {self.publisher_business_field}"  # noqa
...
class dttotDocReportPersonal(models.Model):
    ...
    def __str__(self):
        return f"{self.dttotdoc_report} - {self.dsb_user_personal} - {self.score_match_similarity}"
...
class dttotDocReportCorporate(models.Model):
    ...
    def __str__(self):
        return f"{self.dttotdoc_report} - {self.dsb_user_corporate} - {self.score_match_similarity}"
...
class dttotDocReportCorporatePengurus(models.Model):
    ...
    def __str__(self):
        return f"{self.pengurus_id} - {self.pengurus_name} - {self.pengurus_jabatan} - {self.score_match_similarity}"
...
class dttotDocReportPublisher(models.Model):
    ...
    def __str__(self):
        return f"{self.dttotdoc_report} - {self.dsb_user_publisher} - {self.score_match_similarity}"
