...
AXES_COOLOFF_TIME = timedelta(minutes=int(AXES_COOLOFF_TIME)) if AXES_COOLOFF_TIME else None

AXES_LOCKOUT_PARAMETERS = getenv("AXES_LOCKOUT_PARAMETERS", default=None)
AXES_LOCKOUT_PARAMETERS = AXES_LOCKOUT_PARAMETERS.split(',') if AXES_LOCKOUT_PARAMETERS else None
...
AXES_IPWARE_META_PRECEDENCE_ORDER = getenv("AXES_IPWARE_META_PRECEDENCE_ORDER", default=None)

AXES_RESET_ON_SUCCESS = getenv("AXES_RESET_ON_SUCCESS", default="true").lower() == "true"
AXES_DISABLE_ACCESS_LOG = getenv("AXES_DISABLE_ACCESS_LOG", default="false").lower() == "true"
AXES_ONLY_USER_FAILURES = getenv("AXES_ONLY_USER_FAILURES", default="false").lower() == "true"
AXES_LOCK_OUT_AT_FAILURE = getenv("AXES_LOCK_OUT_AT_FAILURE", default="true").lower() == "true"
...
AXES_HANDLER = getenv("AXES_HANDLER", default='axes.handlers.database.AxesDatabaseHandler')
...
AXES_BEHIND_REVERSE_PROXY = getenv("AXES_BEHIND_REVERSE_PROXY", default="false").lower() == "true"
AXES_REVERSE_PROXY_HEADER = getenv("AXES_REVERSE_PROXY_HEADER", default='HTTP_X_FORWARDED_FOR')
