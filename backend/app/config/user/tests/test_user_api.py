...
class PrivateUserAPITests(TestCase):
    ...
    def test_user_change_password(self):
        ...
        self.assertTrue(self.user.check_password('NewTestpass!123'))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_password_reset_confirmation(self):
        ...
        import re
        reset_link_pattern = re.compile(r'http://testserver/api/user/password/reset/confirm/(?P<uidb64>[0-9a-f-]+)/(?P<token>[0-9A-Za-z-]+)/')  # noqa
