...
from app.dsb_user_corporate.tasks import (  #type: ignore  # noqa: PGH003
    process_dsb_user_corporate_document,
)
from app.dsb_user_personal.tasks import (  #type: ignore  # noqa: PGH003
    process_dsb_user_personal_document,
)
from app.dsb_user_publisher.tasks import (  #type: ignore  # noqa: PGH003
    process_dsb_user_publisher_document,
)
from app.dttotDoc.utils import handle_dttot_document  #type: ignore  # noqa: PGH003
from app.dttotDocReport.tasks import (  #type: ignore  # noqa: PGH003
    create_or_update_dttotdoc_report,
    update_dttotdoc_report_score,
)
from app.dttotDocReportCorporate.tasks import (  #type: ignore  # noqa: PGH003
    scoring_similarity_corporate,
)
from app.dttotDocReportPersonal.tasks import (  #type: ignore  # noqa: PGH003
    scoring_similarity_personal,
)
from app.dttotDocReportPublisher.tasks import (  #type: ignore  # noqa: PGH003
