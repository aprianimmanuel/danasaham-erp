...
def retrieve_dttotdoc_report_corporate(
    dttotreport_corporate_data: dict[str, Any],
) -> DttotDocReportCorporate:
    """Retrieve dttotDocReportCorporate instance with the given data."""
    return DttotDocReportCorporate.objects.filter(**dttotreport_corporate_data).first()

def retrieve_dttotdoc_report_personal(
    dttotreport_personal_data: dict[str, Any],
) -> DttotDocReportPersonal:
    """Retrieve dttotDocReportPersonal instance with the given data."""
    return DttotDocReportPersonal.objects.filter(**dttotreport_personal_data).first()

def retrieve_dttotdoc_report_publisher(
    dttotreport_publisher_data: dict[str, Any],
) -> DttotDocReportPublisher:
    """Retrieve dttotDocReportPublisher instsance with the given data."""
    return DttotDocReportPersonal.objects.filter(**dttotreport_publisher_data).first()
