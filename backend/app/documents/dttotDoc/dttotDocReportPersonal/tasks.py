...
from app.documents.dttotDoc.dttotDocReportPersonal.utils.utils import (  #type: ignore # noqa: PGH003
...
def scoring_similarity_personal(
    ...
    try:
        ...
        dsb_user_personals = DsbUserPersonal.objects.filter(document=document_id)
