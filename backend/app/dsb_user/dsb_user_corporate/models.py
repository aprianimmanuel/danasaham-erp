...
class DsbUserCorporate(models.Model):
    ...
    corporate_sre = models.CharField(  # noqa: DJ001
        _("Corporate Sub Portfolio Account (from Danasaham Core)"),
        max_length=100,
        blank=True,
        null=True,
    )
    corporate_sid = models.CharField(  # noqa: DJ001
        _("Corporate Single Investor Identification (from Danasaham Core)"),
        max_length=100,
        blank=True,
        null=True,
    )
