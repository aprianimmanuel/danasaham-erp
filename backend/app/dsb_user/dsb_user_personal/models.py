...
class DsbUserPersonal(models.Model):
    ...
    personal_ksei_sre = models.CharField(  # noqa: DJ001
        _("Personal KSEI SRE (from Danasaham Core)"),
        max_length=100,
        blank=True,
        null=True,
    )
    personal_ksei_sid = models.CharField(  # noqa: DJ001
        _("Personal KSEI ID (from Danasaham Core)"),
        max_length=100,
        blank=True,
        null=True,
    )
